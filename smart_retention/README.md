# Описание проекта - SmartRetention: Удержание клиентов на основе поведенческих данных
<b>Цель проекта</b>: Построение интерпретируемой модели для прогнозирования снижения покупательской активности клиентов на основе исторических данных и поведенческих признаков, а также выделение ключевых сегментов для последующих бизнес-интервенций.
...
*phik*, *shap*<br><br>
*imblearn:*<br>
*Pipeline*, *SMOTE*, *SMOTETomek*
<br><br>
*sklearn:*<br>
*GridSearchCV*, *StratifiedKFold* <br>
